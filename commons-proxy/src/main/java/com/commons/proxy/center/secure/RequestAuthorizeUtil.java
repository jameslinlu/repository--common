package com.commons.proxy.center.secure;
...
public class RequestAuthorizeUtil {
     ...
     */
    public static void valid(HttpServletRequest request, int diffSeconds) throws ServiceException {
        valid(request.getHeader(RequestAuthorize.PROXY_ID), request.getHeader(RequestAuthorize.PROXY_SIGN), request.getHeader(RequestAuthorize.PROXY_TIME), diffSeconds);
    }

    public static void valid(String requestId, String signature, String timestamp, int diffSeconds) throws ServiceException {
        /*logger.info("Request Authorize Params {} {} {} {} {}",requestId,signature,timestamp,diffSeconds,System.currentTimeMillis());*/
        ...
        if (diffSeconds != -1 && time > (1000l * diffSeconds)) {
            logger.info("Request Spend {} ms",time);
