...
import static com.commons.common.utils.ipv6.IPv6AddressHelpers.prefixWithZeroBytes;
...
public final class IPv6Address implements Comparable<IPv6Address>, Serializable {
     ...
     * IPv6Addresses from a {@link String} or an {@link InetAddress}. The internal representation of an IPv6Address is exactly
    ...
    /**
     * Create an IPv6 address from a (positive) {@link BigInteger}. The magnitude of the {@link BigInteger} represents
     * the IPv6 address value. Or in other words, the {@link BigInteger} with value N defines the Nth possible IPv6 address.
     *
     * @param bigInteger {@link BigInteger} value
     * @return IPv6 address
     */
    ...
    /**
     * @return {@link BigInteger} representation. The magnitude of the {@link BigInteger} represents the IPv6 address
     * value. Or in other words, the {@link BigInteger} with value N defines the Nth possible IPv6 address.
     */
