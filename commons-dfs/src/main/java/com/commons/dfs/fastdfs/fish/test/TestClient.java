...
package com.commons.dfs.fastdfs.fish.test;
...
//  	}
        ...
        String conf_filename = "G:\\文档\\云端卫士\\部署\\fdfs_client.conf";//args[0];
        String local_filename = "G:\\文档\\云端卫士\\部署\\oauth2.0.png";//args[1];
        ...
        try {
  		...
  		*/
            ...
            byte[] file_buff;
            com.commons.dfs.fastdfs.fish.common.NameValuePair[] meta_list;
            String[] results;
            ...
            meta_list = new com.commons.dfs.fastdfs.fish.common.NameValuePair[4];
            meta_list[0] = new com.commons.dfs.fastdfs.fish.common.NameValuePair("width", "800");
            meta_list[1] = new com.commons.dfs.fastdfs.fish.common.NameValuePair("heigth", "600");
            meta_list[2] = new com.commons.dfs.fastdfs.fish.common.NameValuePair("bgcolor", "#FFFFFF");
            meta_list[3] = new com.commons.dfs.fastdfs.fish.common.NameValuePair("author", "Mike");
  		...
  		*/
            if (results == null) {
                ...
                meta_list = new com.commons.dfs.fastdfs.fish.common.NameValuePair[4];
                meta_list[0] = new com.commons.dfs.fastdfs.fish.common.NameValuePair("width", "1024");
                meta_list[1] = new com.commons.dfs.fastdfs.fish.common.NameValuePair("heigth", "768");
                meta_list[2] = new com.commons.dfs.fastdfs.fish.common.NameValuePair("bgcolor", "#000000");
                meta_list[3] = new com.commons.dfs.fastdfs.fish.common.NameValuePair("title", "Untitle");
