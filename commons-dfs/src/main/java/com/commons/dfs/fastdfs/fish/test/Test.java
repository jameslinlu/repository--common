...
public class Test {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            com.commons.dfs.fastdfs.fish.common.NameValuePair[] metaList = new com.commons.dfs.fastdfs.fish.common.NameValuePair[1];
            metaList[0] = new com.commons.dfs.fastdfs.fish.common.NameValuePair("fileName", local_filename);
