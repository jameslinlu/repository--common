...
public class ClientGlobal {
     ...
     */
    public static void init(String conf_filename) throws FileNotFoundException, IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        com.commons.dfs.fastdfs.fish.common.IniFileReader iniReader;
        String[] szTrackerServers;
        String[] parts;

        iniReader = new com.commons.dfs.fastdfs.fish.common.IniFileReader(conf_filename);
        ...
        if (szTrackerServers == null) {
            throw new com.commons.dfs.fastdfs.fish.common.MyException("item \"tracker_server\" in " + conf_filename + " not found");
        }
        ...
        for (int i = 0; i < szTrackerServers.length; i++) {
            ...
            if (parts.length != 2) {
                throw new com.commons.dfs.fastdfs.fish.common.MyException("the value of item \"tracker_server\" is invalid, the correct format is host:port");
            }
