...
package com.commons.dfs.fastdfs.fish;
...
public class StorageClient1 extends StorageClient {
    ...
    public String upload_file1(String local_filename, String file_ext_name,
                               com.commons.dfs.fastdfs.fish.common.NameValuePair[] meta_list) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
    ...
    public String upload_file1(String master_file_id, String prefix_name,
                               String local_filename, String file_ext_name, com.commons.dfs.fastdfs.fish.common.NameValuePair[] meta_list) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
     ...
     */
    public String upload_file1(String master_file_id, String prefix_name,
                               byte[] file_buff, String file_ext_name, com.commons.dfs.fastdfs.fish.common.NameValuePair[] meta_list) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(master_file_id, parts);
        if (this.errno != 0) {
            return null;
     ...
     */
    public int append_file1(String appender_file_id, String local_filename) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
     ...
     * @return 0 for success, != 0 for error (error no)
     */
    public int append_file1(String appender_file_id, byte[] file_buff) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     * @return 0 for success, != 0 for error (error no)
     */
    public int append_file1(String appender_file_id, byte[] file_buff, int offset, int length) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     * @return 0 for success, != 0 for error (error no)
     */
    public int append_file1(String appender_file_id, long file_size, UploadCallback callback) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
    ...
    public int modify_file1(String appender_file_id,
                            long file_offset, String local_filename) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     */
    public int modify_file1(String appender_file_id,
                            long file_offset, byte[] file_buff) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     */
    public int modify_file1(String appender_file_id,
                            long file_offset, byte[] file_buff, int buffer_offset, int buffer_length) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     */
    public int modify_file1(String appender_file_id,
                            long file_offset, long modify_size, UploadCallback callback) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     */
    public int delete_file1(String file_id) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
     ...
     * @return 0 for success, none zero for fail (error code)
     */
    public int truncate_file1(String appender_file_id) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     * @return 0 for success, none zero for fail (error code)
     */
    public int truncate_file1(String appender_file_id, long truncated_file_size) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     */
    public byte[] download_file1(String file_id) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
     ...
     */
    public byte[] download_file1(String file_id, long file_offset, long download_bytes) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return null;
     ...
     */
    public int download_file1(String file_id, String local_filename) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        final long file_offset = 0;
        final long download_bytes = 0;
     ...
     * @return 0 success, return none zero errno if fail
     */
    public int download_file1(String file_id, long file_offset, long download_bytes, String local_filename) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     * @return 0 success, return none zero errno if fail
     */
    public int download_file1(String file_id, DownloadCallback callback) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        final long file_offset = 0;
        final long download_bytes = 0;
     ...
     * @return 0 success, return none zero errno if fail
     */
    public int download_file1(String file_id, long file_offset, long download_bytes, DownloadCallback callback) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     */
    public com.commons.dfs.fastdfs.fish.common.NameValuePair[] get_metadata1(String file_id) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return null;
     ...
     */
    public int set_metadata1(String file_id, com.commons.dfs.fastdfs.fish.common.NameValuePair[] meta_list, byte op_flag) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     */
    public FileInfo query_file_info1(String file_id) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return null;
     ...
     * @return FileInfo object for success, return null for fail
     */
    public FileInfo get_file_info1(String file_id) throws IOException, com.commons.dfs.fastdfs.fish.common.MyException {
        String[] parts = new String[2];
        this.errno = this.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return null;
